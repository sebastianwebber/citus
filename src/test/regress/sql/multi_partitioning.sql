...
CREATE TABLE non_distributed_child (event_id int NOT NULL, event_time timestamptz NOT NULL DEFAULT now());
ALTER TABLE distributed_parent_table ATTACH PARTITION non_distributed_child FOR VALUES FROM ('2021-06-30') TO ('2021-07-01');
